 ...
 * File: UICompSevenSegmentFreq.cpp                                                                                    *
 ...
 * -----                                                                                                               *
 * Last Modified: 2025.11.16, Sunday  09:44:47                                                                         *
 * Modified By: BT-Soft                                                                                                *
 * -----                                                                                                               *
 * HISTORY:                                                                                                            *
 * Date      	By	Comments                                                                                           *
...
// Törlési terület szélessége (frekvencia + mértékegység), pl.: a BFO animáció előtt és után
constexpr static uint16_t CLEAR_AREA_WIDTH = 250;
